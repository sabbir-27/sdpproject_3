...
class HighPriorityComplaintListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Complaint> highPriorityComplaints = complaintProvider.complaints
        .where((c) => c.escalatedToPolice)
        .toList();
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: highPriorityComplaints.isEmpty
            ? Center(
                child: Column(
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final complaint = highPriorityComplaints[index];
